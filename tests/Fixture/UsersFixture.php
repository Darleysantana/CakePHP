...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'roles_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'roles_id' => 1,
                'created' => '2021-04-08 01:45:26',
                'modified' => '2021-04-08 01:45:26',
            ],
        ];
        parent::init();
    }
